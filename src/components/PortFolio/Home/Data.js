...
const Data = () => {
  return (
    <div className="homeData">
      ...
      <p className="homeDesctiption">
        Full tack programmer and Electronic Engineer with interests in IoT: IDE:
        Visual Studio, VSC. Control Version: Git and Github. back end
        Programming Languages: Matlab, Labview, C, C# Frameworks: .NET Core with
        MVC, MVM, NodeJS, React, Redux Front-end Programming Languages:
        Javascript, HTML5, CSS3, NodeJS, React framework and libraries, Redux,
        Databases: MySQL, Postgresql, OS: Linux 2012-2019, (PID, PI, PD
        Management) Microcontrollers: Embedded programming PIC, ARM, AVR,
        networks (WAN, LAN)
      </p>
