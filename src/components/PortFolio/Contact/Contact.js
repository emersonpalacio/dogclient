...
const Contact = () => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          alert(
            "Email was sent successfully, I will contact you as soon as possible "
          );
        },
        (error) => {
  ...
  return (
    <section className="contact section" id="contact">
      <h2 className="sectionTtitle">Get in touch</h2>

      <span className="sectionSubtitle">Contact My</span>
      <div className="contactContainer container grid">
        <div className="contactContent">
          <h3 className="contactTitle">Talk to my</h3>
          <div className="contactInfo">
            <div className="contactCard">
              ...
              <span className="contactCardData">
                emersonpalaciootalvaro@gmail.com
              </span>
            ...
            <div className="contactCard">
              ...
              <span className="contactCardData">302-4299-5963</span>

              <a href="https://whatsapp.com/dl/" className="contactButton">
                Write my
                <i className="bx bx-right-arrow-alt ContactButtonIcon"></i>
              </a>
            </div>
            ...
            {/* <div className="contactCard">
              ...
              <h3 className="contactCardTitle"></h3>
              <span className="contactCardData"></span>
        ...
        <div className="contactContent">
          <h3 className="contactTitle">Write me your proyect</h3>

          <form ref={form} onSubmit={sendEmail} className="comtactForm">
            ...
            <div className="contactFormDiv contactFormArea">
              <label className="contactFormTag">Proyect</label>
              <textarea
                name="proyect"
                cols="30"
                rows="10"
                className="contactFormInput contactFormTetxArea "
                placeholder="Write your Proyect"
              />
            </div>
            <button type="submit" className="button ButtonFlex">
              Send message
              <svg
                width="36"
                height="36"
