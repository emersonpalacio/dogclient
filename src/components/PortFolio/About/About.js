...
import CV from "../assets/EmersonCV.pdf";
      ...
      <div className="aboutContainer container grid">
        ...
        <div className="aboutData">
          ...
          <p className="aboutDescription">
            Front-end and back-end Developer | Javascript | React | Nod.js|C#
            .NetCore | Functional programming js, nod.js FullStack Developer in
            js, nod.js and bookshop react Programming.
          </p>
